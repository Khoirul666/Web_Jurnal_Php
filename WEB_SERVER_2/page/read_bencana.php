<div class="row">
    <div class="col-sm-12">
        <div class="card">
            ...
            <?php
            $data_bencana = $koneksi->query("SELECT * FROM laporan LEFT JOIN tb_kecamatan ON laporan.kecamatan=tb_kecamatan.id_kecamatan where id='".$_GET['id']."' AND jenis='Laporan Bencana'");
            while($data = mysqli_fetch_array($data_bencana)){
                // echo $data['is_read'];
                if ($data['is_read']=='false') {
                    $koneksi->query("UPDATE laporan SET is_read='true' WHERE id='".$_GET['id']."' AND jenis='Laporan Bencana'");
                }
                ?>
                <div class="card-block">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="lokasi" placeholder="Lokasi Bencana" required value="<?= $data['nama_kecamatan'] ?>">
                        </div>
                    </div>
                    <div class="form-group row">
