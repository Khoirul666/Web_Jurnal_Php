    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header">
                <h5>TAMBAH DATA BENCANA</h5>
                <div class="p-t-20">
                    <a href="index.php?data=bencana" class="btn btn-success btn-sm text-white"><i class="fa fa-arrow-left"></i> KEMBALI</a>
                </div>
            </div>
            <form action="proses.php?data=tambah_bencana" enctype="multipart/form-data" method="POST">
                <div class="card-block">
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Upload File</label>
                        <div class="col-sm-9">
                            <input type="file" class="form-control" name="gmbr" placeholder="Gambar Bencana" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Nama Pelapor</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="nm_pelapor" placeholder="Nama Bencana" required>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="lokasi" placeholder="Lokasi Bencana" required>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="date" class="form-control" name="tanggal" placeholder="Tanggal Bencana" required>
                        </div>
                    </div>
                    <div class="form-group row">
