<div class="row">
    <div class="col-sm-12">
        <div class="card">
            ...
            <?php
            $data_kejadian = $koneksi->query("SELECT * FROM laporan LEFT JOIN tb_kecamatan ON laporan.kecamatan=tb_kecamatan.id_kecamatan where id='".$_GET['id']."'");
            while($data = mysqli_fetch_array($data_kejadian)){
                ...
                ?>
                <form action="proses.php?data=ubah_kejadian&id=<?= $data['id'] ?>" enctype="multipart/form-data" method="POST">
                    <div class="card-block">
                        <input type="hidden" name="id" value="<?= $data['id'] ?>">
                        <div class="form-group row">
                            <label class="col-sm-3 col-form-label">Upload File</label>
                            <div class="col-sm-9">
                                <input type="file" class="form-control" name="gmbr" placeholder="Gambar Kejadian">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-3 col-form-label">Nama Pelapor</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="nm_pelapor" placeholder="Nama Kejadian" required value="<?= $data['nm_pelapor'] ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="lokasi" placeholder="Lokasi Kejadian" required value="<?= $data['lokasi'] ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="date" class="form-control" name="tanggal" placeholder="Tanggal Kejadian" required value="<?= $data['tanggal'] ?>">
                            </div>
                        </div>
                        <div class="form-group row">
