...
$(document).ready(function(){
	$(".card-header-right .close-card").on("click",function(){
		var a=$(this);a.parents(".card").animate({
	...
	$(".card-header-right .reload-card").on("click",function(){var a=$(this);
